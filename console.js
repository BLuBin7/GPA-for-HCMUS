...
console.log(`-> GPA: ${ans}`);
round = ans.toFixed(2);
if(round >=9 && round < 10) console.log(`Diem sau khi lam tron : ${round} ->Xuat Sac`);
else if(round >=8 && round <9) console.log(`Diem sau khi lam tron : ${round} -> Gioi`);
else if ( round >=7 && round <8) console.log(`Diem sau khi lam tron : ${round} -> Kha`);
else if(round>=6 && round <7) console.log(`Diem sau khi lam tron : ${round} -> Trung Binh Kha`);
else if(round >=5 && round < 6) console.log(`Diem sau khi lam tron : ${round} -> Trung Binh`);
